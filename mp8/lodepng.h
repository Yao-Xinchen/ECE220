...
For < 8 bpp input, there should not be padding bits at the end of scanlines.
...
typedef struct LodePNGEncoderSettings
{
  ...
  must be set to 0 to ensure this is also used on palette or low bitdepth input.*/
...
PNG is a file format to store raster input losslessly with good compression,
...
*) the following chunks are supported (generated/interpreted) by both encoder and decoder:
    ...
    tRNS: transparency for palettized input
...
the color format of the input yourself, you can skip this chapter.
...
*) 13 jan 2008: Added ability to encode Adam7-interlaced input. Improved
...
*) 08 jun 2007: fixed bug with 2- and 4-bit color, and small interlaced input
...
*) 04 mar 2007: (!) tEXt chunk related fixes, and support for encoding
    palettized PNG input. Plus little interface change with palette and texts.
...
*) 29 dec 2006: Added support for encoding input without alpha channel, and
