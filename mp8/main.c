...
int main(int argc, const char *const argv[])
{
    ...
    if (7 > argc || 8 < argc || 1 != sscanf(argv[3], "%d%1s", &command, garbage) || 1 > command || 3 < command ||
    ...
    {
        case 1:
            basicFlood(width, height, inRed, inGreen, inBlue, startX, startY, floodR, floodG, floodB, outRed, outGreen,
                       outBlue);
            break;
        case 2:
            greyFlood(width, height, inRed, inGreen, inBlue, startX, startY, floodR, floodG, floodB, distSq, outRed,
                      outGreen, outBlue);
            break;
        case 3:
            limitedFlood(width, height, inRed, inGreen, inBlue, startX, startY, floodR, floodG, floodB, distSq, outRed,
                         outGreen, outBlue);
            break;
    }
